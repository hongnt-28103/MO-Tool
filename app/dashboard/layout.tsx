...
const C = { ink:"#F8FAFC", ink2:"#FFFFFF", panel:"#FFFFFF", border:"#E2E8F0", border2:"#CBD5E1",
  text:"#0F172A", text2:"#475569", text3:"#94A3B8", accent:"#059669", accentDim:"rgba(5,150,105,0.10)", red:"#DC2626" };
    ...
    <div style={{ display:"flex", minHeight:"100vh", background:C.ink, fontFamily:FS }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        ::-webkit-scrollbar{width:4px;} ::-webkit-scrollbar-thumb{background:${C.border2};border-radius:2px;} ::-webkit-scrollbar-track{background:${C.ink2};}
      ...
      <nav style={{ width:220, minWidth:220, background:C.ink2, borderRight:`1px solid ${C.border}`,
        ...
        <div style={{ padding:"20px 16px 16px", borderBottom:`1px solid ${C.border}` }}>
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
            <div style={{ width:32, height:32, borderRadius:8, background:C.accentDim,
              border:"1px solid rgba(5,150,105,0.3)", display:"flex", alignItems:"center",
        ...
        <div style={{ padding:"12px 16px", borderBottom:`1px solid ${C.border}` }}>
          {loading ? (
            ...
            <div style={{ padding:"8px 10px", background:"rgba(220,38,38,0.10)", border:"1px solid rgba(220,38,38,0.3)",
              borderRadius:7, fontSize:11, color:"#FF5F5F", lineHeight:1.5 }}>{pubErr}</div>
          ) : pub ? (
            <div style={{ background:C.accentDim, border:"1px solid rgba(5,150,105,0.2)", borderRadius:7, padding:"8px 11px" }}>
