...
const C = { ink:"#F8FAFC", ink2:"#FFFFFF", panel:"#FFFFFF", border:"#E2E8F0", border2:"#CBD5E1",
  text:"#0F172A", text2:"#475569", text3:"#94A3B8", accent:"#059669", accentDim:"rgba(5,150,105,0.10)",
  yellow:"#D97706", yellowDim:"rgba(217,119,6,0.10)", red:"#DC2626" };
      ...
      <div className="fu" style={{ position:"relative", width:400, background:C.panel,
        ...
        <div style={{ textAlign:"center", marginBottom:32 }}>
          <div style={{ display:"inline-flex", alignItems:"center", justifyContent:"center",
            ...
            background:C.accentDim, border:"1px solid rgba(5,150,105,0.3)", fontSize:24 }}>
            📡
          </div>
        ...
        {error && (
          <div style={{ padding:"11px 14px", borderRadius:8, fontSize:12.5, marginBottom:20,
            background:"rgba(220,38,38,0.10)", border:"1px solid rgba(220,38,38,0.3)", color:"#DC2626",
        ...
        <a href="/api/auth/login" style={{ display:"block", textDecoration:"none" }}>
          <button style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:10,
            ...
            background:C.accent, color:"#FFFFFF", fontSize:14, fontWeight:700,
